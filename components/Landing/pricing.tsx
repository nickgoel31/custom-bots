  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-muted -200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
      <div className="p-8 sm:p-10 lg:flex-auto">
        ...
        <p className="mt-6 text-base leading-7 -600">
            Get access to our basic features and build a bot for free. No credit card required.
        </p>
        <div className="mt-10 flex items-center gap-x-4">
          <h4 className="flex-none text-sm font-semibold leading-6 text-indigo-600">What&apos;s included</h4>
          <div className="h-px flex-aut-100"></div>
        </div>
        <ul role="list" className="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 -600 sm:grid-cols-2 sm:gap-6">
      ...
      <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
        <div className="rounded-2x-50 py-10 text-center ring-1 ring-muted ring-inset /5 lg:flex lg:flex-col lg:justify-center lg:py-16">
          <div className="mx-auto max-w-xs px-8">
            <p className="text-base font-semibold -600">
                For Everybody
            </p>
    ...
    <div className="mx-auto max-w-2xl rounded-3xl ring-1 ring-muted -200 sm:mt-8 lg:mx-0 lg:flex lg:max-w-none">
      <div className="p-8 sm:p-10 lg:flex-auto">
        <h3 className="text-2xl font-bold tracking-tight ">
            Premium
        </h3>
        <p className="mt-6 text-base leading-7 -600">
            Get access to all our features and build a bot for free. 3 days free trial
        </p>
        <div className="mt-10 flex items-center gap-x-4">
          <h4 className="flex-none text-sm font-semibold leading-6 text-indigo-600">What&apos;s included</h4>
          <div className="h-px flex-aut-100"></div>
